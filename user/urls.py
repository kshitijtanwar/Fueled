...
from .views import ProfileViewSet, EventViewSet, RSVPViewSet, SubEventViewSet, JoinSubEventView
...
urlpatterns = [
    ...
    path('join_subevent/<str:join_code>/', JoinSubEventView.as_view(), name='join_subevent'),
]